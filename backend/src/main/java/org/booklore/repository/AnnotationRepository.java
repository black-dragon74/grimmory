...
public interface AnnotationRepository extends JpaRepository<AnnotationEntity, Long> {
    ...
    Optional<AnnotationEntity> findByExternalIdAndBookIdAndUserId(String externalId, Long bookId, Long userId);

    List<AnnotationEntity> findByExternalIdInAndBookIdAndUserId(List<String> externalIds, Long bookId, Long userId);
}
